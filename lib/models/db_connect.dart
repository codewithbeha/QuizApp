...
class DBconnect {
  ...
  //declare the name of the table you want to create and add
  // .json as suffix

  final url = Uri.parse(
      'https://simplequizapp-7fbd6-default-rtdb.firebaseio.com/questions.json');
  ...
  //       }));
  // } --> the addQuestion function static to create question manually.

  //fetcj the data from databse

  Future<List<Question>> fetchQuestions() async {
    //we got the data from just using this. now let's print it to see what we go.
